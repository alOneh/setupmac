...
```
curl -s https://raw.githubusercontent.com/al0neh/setupmac/master/start.sh | /bin/bash
```
...
what get's installed at [here](https://raw.githubusercontent.com/al0neh/setupmac/master/roles/setup/vars/main.yml). If you want to change the list of applications, clone
